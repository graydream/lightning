...
free_sl (etcd_server *server_list){
        ...
        LTG_ASSERT(num_servers == 1);
        LTG_ASSERT(server_list[num_servers].host == NULL);
        LTG_ASSERT(server_list[num_servers].port == 0);
#endif
...
#if ENABLE_ETCD_DBUG
                LTG_ASSERT(server_list[1].host == NULL);
                LTG_ASSERT(server_list[1].port == 0);
#endif
