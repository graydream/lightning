...
#define __s_offsetof(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)
 ...
 *
 */
#define __s_container_of(ptr, type, member) ({                      \
        const typeof( ((type *)0)->member ) *__mptr = (ptr);    \
        (type *)( (char *)__mptr - __s_offsetof(type,member) );})
...
#define list_entry(ptr, type, member) \
        __s_container_of(ptr, type, member)
...
#define hlist_entry(ptr, type, member) __s_container_of(ptr,type,member)
